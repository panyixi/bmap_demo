    ...
    */
    TextIconOverlay.prototype._buildCssText = function(style) {    
        ...
        if (T.browser["ie"] < 7) {
            ...
            csstext.push('background-size:41px 33px;');//自定义背景图片大小
     ...
     * @name TextIconOverlay#touchstart
     ...
     * myTextIconOverlay.addEventListener("touchstart", function(e) {  alert(e.point);  });
     ...
     * myTextIconOverlay.addEventListener("touchend", function(e) {  alert(e.point);  });

     */

    /**
    * 为该覆盖物绑定一系列事件
    * 当前支持click mouseover mouseout touchstart touchend
    * @return 无返回值。
    */
    TextIconOverlay.prototype._bind = function(){
        ...
        //add by panyixi
        T.event.on(this._domElement,"touchstart", function(e){
            me.dispatchEvent(eventExtend(e, new BaseEvent("ontouchstart")));
        });
        T.event.on(this._domElement,"touchend", function(e){
            me.dispatchEvent(eventExtend(e, new BaseEvent("ontouchend")));
        });
    };
